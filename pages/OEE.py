...
dash.register_page(__name__, external_stylesheets=[dbc.themes.DARKLY], src="/OEE",title="Dashboard", meta_tags=[
...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dcc.Loading(dcc.Graph(id='graph-content'), type="cube")
            ]
        ),
    ], fluid=True, style={
