...
dash.register_page(__name__, external_stylesheets=[dbc.themes.DARKLY],src="/bar2")
# dash.register_page
...
layout = dbc.Container(
    [
        dcc.Markdown(
            "% of breakdown by time and frequency",
            style={'fontSize': 40,
                   'textAlign': 'center',
                   'color': 'white'},
            className="my-4",
...
def render_content(value):
    ...
    bar1_fig['layout'].update(height=800, width=900, xaxis=dict(tickangle=90))
    ...
    bar2_fig['layout'].update(height=800, width=900, xaxis=dict(
        tickangle=90
    ))
